...
window.cpRSA = function()
{
    ...
    this.oRSAkey = null;
	 ...
	 this.savePublicKey = function(m, e)
    {
        ...
        {
            //DEBUG.out('RSA public key invalid!\nm(' + this.m +')\ne(' + this.e + ')',DEBUG.ERROR);
        }
	}
	...
	this.initPublicKey = function()
    {
       // this.oRSAkey = new RSAKey();	// jsbn library
		...
		//pay attention that the m and e don't include problematic strings
		var modulus = '';
		var exponent = '010001';
	...
	this.encrypt = function(text)
    {
        ...
        {
            alert('Did you call initPublicKey? Did it fail?');
